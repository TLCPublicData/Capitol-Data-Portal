...
def make_map():
    ...
    # group
    map.redirect('/topics', '/topic')
    map.redirect('/topics/{url:.*}', '/topic/{url}')
    ...
    with SubMapper(map, controller='group') as m:
        m.connect('group_index', '/topic', action='index',
                  highlight_actions='index search')
        m.connect('group_list', '/topic/list', action='list')
        m.connect('group_new', '/topic/new', action='new')
        ...
        m.connect('group_about', '/topic/about/{id}', action='about',
                  ckan_icon='info-circle'),
        m.connect('group_edit', '/topic/edit/{id}', action='edit',
                  ckan_icon='pencil-square-o')
        m.connect('group_members', '/topic/members/{id}', action='members',
                  ckan_icon='users'),
        m.connect('group_activity', '/topic/activity/{id}/{offset}',
                  action='activity', ckan_icon='clock-o'),
        m.connect('group_read', '/topic/{id}', action='read',
                  ckan_icon='sitemap')
